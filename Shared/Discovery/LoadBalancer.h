...
namespace Helianthus::Discovery
{
    ...
    public:
        ...
        std::vector<ServiceInstancePtr> GetServiceInstances(const std::string& ServiceName) const override;
        ...
        ServiceInstancePtr SelectInstanceWithStrategy(const std::string& ServiceName, LoadBalanceStrategy Strategy) override;
        ServiceInstancePtr SelectInstanceWithContext(const std::string& ServiceName, const std::string& Context) override;
        ServiceInstancePtr SelectInstanceWithWeight(const std::string& ServiceName, LoadWeight MinWeight = 0) override;
        ServiceInstancePtr SelectHealthiestInstance(const std::string& ServiceName) override;

        // 策略配置
        void SetLoadBalanceStrategy(const std::string& ServiceName, LoadBalanceStrategy Strategy) override;
        ...
        std::vector<ServiceInstancePtr> GetHealthyInstances(const std::string& ServiceName) const override;
        ...
        // 粘性会话
        void EnableStickySession(const std::string& ServiceName, const std::string& SessionKey) override;
        ...
        ServiceInstancePtr GetStickyInstance(const std::string& ServiceName, const std::string& SessionId) override;
        DiscoveryResult BindSession(const std::string& ServiceName, const std::string& SessionId, ServiceInstanceId InstanceId) override;
        void UnbindSession(const std::string& ServiceName, const std::string& SessionId) override;

        // 一致性哈希
        void EnableConsistentHashing(const std::string& ServiceName, uint32_t VirtualNodes = 150) override;
        ...
        ServiceInstancePtr GetConsistentHashInstance(const std::string& ServiceName, const std::string& Key) override;
        ...
        std::unordered_map<ServiceInstanceId, uint32_t> GetLoadDistribution(const std::string& ServiceName) const override;
        void UpdateLoadMetrics(ServiceInstanceId InstanceId, float CpuUsage, float MemoryUsage, float NetworkUsage) override;
        ...
        ServiceInstancePtr SelectInstanceByLocation(const std::string& ServiceName, const std::string& Region, const std::string& Zone) override;
        ...
        void SetInstanceFailureCallback(std::function<void(ServiceInstanceId InstanceId, const std::string& Reason)> Callback) override;
        ...
        void TuneBalancingParameters(const std::string& ServiceName, const std::unordered_map<std::string, float>& Parameters) override;
    ...
    private:
        ...
        // 辅助方法
        ServiceInstancePtr SelectHealthyInstance(const std::string& ServiceName, LoadBalanceStrategy Strategy);
