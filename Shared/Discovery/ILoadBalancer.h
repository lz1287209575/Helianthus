...
public:
    ...
    virtual std::vector<ServiceInstancePtr>
    GetServiceInstances(const std::string& ServiceName) const = 0;
    ...
    virtual ServiceInstancePtr SelectInstanceWithStrategy(const std::string& ServiceName,
                                                          LoadBalanceStrategy Strategy) = 0;
    virtual ServiceInstancePtr SelectInstanceWithContext(const std::string& ServiceName,
                                                         const std::string& Context) = 0;
    virtual ServiceInstancePtr SelectInstanceWithWeight(const std::string& ServiceName,
                                                        LoadWeight MinWeight = 0) = 0;
    virtual ServiceInstancePtr SelectHealthiestInstance(const std::string& ServiceName) = 0;

    // Strategy configuration
    virtual void SetLoadBalanceStrategy(const std::string& ServiceName,
                                        LoadBalanceStrategy Strategy) = 0;
    ...
    virtual std::vector<ServiceInstancePtr>
    GetHealthyInstances(const std::string& ServiceName) const = 0;
    ...
    // Sticky sessions
    virtual void EnableStickySession(const std::string& ServiceName,
    ...
    virtual ServiceInstancePtr GetStickyInstance(const std::string& ServiceName,
                                                 const std::string& SessionId) = 0;
    virtual DiscoveryResult BindSession(const std::string& ServiceName,
                                        const std::string& SessionId,
                                        ServiceInstanceId InstanceId) = 0;
    virtual void UnbindSession(const std::string& ServiceName, const std::string& SessionId) = 0;

    // Consistent hashing
    virtual void EnableConsistentHashing(const std::string& ServiceName,
                                         uint32_t VirtualNodes = 150) = 0;
    ...
    virtual ServiceInstancePtr GetConsistentHashInstance(const std::string& ServiceName,
    ...
    virtual std::unordered_map<ServiceInstanceId, uint32_t>
    GetLoadDistribution(const std::string& ServiceName) const = 0;
    virtual void UpdateLoadMetrics(ServiceInstanceId InstanceId,
                                   float CpuUsage,
                                   float MemoryUsage,
    ...
    virtual ServiceInstancePtr SelectInstanceByLocation(const std::string& ServiceName,
    ...
    virtual void SetInstanceFailureCallback(
        std::function<void(ServiceInstanceId InstanceId, const std::string& Reason)> Callback) = 0;
    ...
    virtual void
    TuneBalancingParameters(const std::string& ServiceName,
                            const std::unordered_map<std::string, float>& Parameters) = 0;
};
