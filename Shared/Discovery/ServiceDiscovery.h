...
namespace Helianthus::Discovery
{
    ...
    public:
        ...
        // 高级服务发现 - 结合负载均衡和健康检查
        ServiceInstancePtr DiscoverService(const std::string& ServiceName,
        ...
        // 事件回调
        void SetServiceStateChangeCallback(std::function<void(ServiceInstanceId, ServiceState, ServiceState)> Callback);
        void SetServiceRegistrationCallback(std::function<void(ServiceInstanceId, DiscoveryResult)> Callback);
        void SetHealthAlertCallback(std::function<void(ServiceInstanceId, HealthScore, const std::string&)> Callback);
        void SetLoadBalanceCallback(std::function<void(ServiceInstanceId, const std::string&)> Callback);
    ...
    private:
        ...
        // 事件处理
        void OnServiceStateChanged(ServiceInstanceId InstanceId, ServiceState OldState, ServiceState NewState);
