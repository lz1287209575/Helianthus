...
public:
    ...
    const HPropertyInfo* GetHPropertyInfo(const std::string& ClassName,
                                          const std::string& PropertyName) const;
    const HFunctionInfo* GetHFunctionInfo(const std::string& ClassName,
    ...
    void* CallHFunction(void* Object,
    ...
    std::string GenerateHPropertyCode(const std::string& ClassName,
                                      const std::string& PropertyName) const;
    std::string GenerateHFunctionCode(const std::string& ClassName,
                                      const std::string& FunctionName) const;
...
// 简化的运行时反射宏
#define HELIANTHUS_CLASS(ClassName, BaseClass) class ClassName : public BaseClass

#define HELIANTHUS_PROPERTY(PropertyName, PropertyType) PropertyType PropertyName;

#define HELIANTHUS_FUNCTION(FunctionName, ReturnType, ...) ReturnType FunctionName(__VA_ARGS__);

#define HELIANTHUS_ENUM(EnumName) enum class EnumName : int32_t
