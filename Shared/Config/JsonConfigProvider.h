...
namespace Helianthus::Config
{
    ...
    public:
        ...
        std::unordered_map<std::string, ConfigValue> GetSection(const std::string& Prefix) const override;
    ...
    private:
        ...
        void CollectKeysRecursive(const nlohmann::json& JsonObj, const std::string& Prefix, std::vector<std::string>& Keys) const;
        ...
        void NotifyConfigChange(const std::string& Key, const ConfigValue& OldValue, const ConfigValue& NewValue);
