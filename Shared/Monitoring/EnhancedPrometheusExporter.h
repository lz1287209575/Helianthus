...
public:
    ...
    // 性能统计管理
    void UpdateBatchPerformance(const std::string& QueueName,
                                uint64_t DurationNs,
                                uint64_t MessageCount);
    void UpdateZeroCopyPerformance(uint64_t DurationNs);
    void UpdateTransactionPerformance(bool Committed,
                                      bool RolledBack,
                                      bool Timeout,
                                      bool Failed,
                                      uint64_t CommitTimeNs = 0,
                                      uint64_t RollbackTimeNs = 0);
