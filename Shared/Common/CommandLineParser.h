...
#define HELIANTHUS_CLI_STRING(parser, short_name, long_name, desc, required, default_val)          \
    parser.AddArgument(                                                                            \
        short_name, long_name, desc, CommandLineParser::ArgType::STRING, required, default_val)

#define HELIANTHUS_CLI_INTEGER(parser, short_name, long_name, desc, required, default_val)         \
    parser.AddArgument(                                                                            \
        short_name, long_name, desc, CommandLineParser::ArgType::INTEGER, required, default_val)

#define HELIANTHUS_CLI_FLOAT(parser, short_name, long_name, desc, required, default_val)           \
    parser.AddArgument(                                                                            \
        short_name, long_name, desc, CommandLineParser::ArgType::FLOAT, required, default_val)
