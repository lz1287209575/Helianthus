...
{
public:
    explicit CategoryLogger(std::shared_ptr<spdlog::logger> LoggerPtr) : LoggerInstance(LoggerPtr)
    {
    }
    ...
    void
    Log(spdlog::level::level_enum Level, fmt::format_string<Args...> Format, Args&&... Arguments)
    {
