...
public:
    ...
    virtual RpcFuture<std::pair<RpcResult, std::string>> CallFuture(const std::string& ServiceName,
                                                                    const std::string& MethodName,
                                                                    const std::string& Parameters,
                                                                    uint32_t TimeoutMs = 0) = 0;
...
public:
    ...
    RpcFuture<std::pair<RpcResult, std::string>> CallFuture(const std::string& ServiceName,
                                                            const std::string& MethodName,
                                                            const std::string& Parameters,
                                                            uint32_t TimeoutMs = 0) override;
