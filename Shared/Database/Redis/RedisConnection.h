...
namespace Helianthus::Database::Redis
{
    ...
    struct RedisResult
    {
        ...
        bool HasHashValues() const { return !HashValues.empty(); }
    };
    ...
    public:
        ...
        redisContext* GetRedisHandle() const { return RedisContext; }
        const RedisConfig& GetConfig() const { return Config; }
        ...
        RedisResult SortedSetRange(const std::string& Key, int32_t Start, int32_t Stop, bool WithScores = false);
