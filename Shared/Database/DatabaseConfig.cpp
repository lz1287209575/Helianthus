...
namespace Helianthus::Database
{
    ...
    MySqlConfig DatabaseConfigManager::GetMySqlConfig(const std::string& ConnectionName) const
    {
        ...
        {
            HELIANTHUS_LOG_WARN("MySQL configuration not found for connection: {}, using defaults", ConnectionName);
            return MySqlConfig{};
        }
    ...
    MongoDbConfig DatabaseConfigManager::GetMongoDbConfig(const std::string& ConnectionName) const
    {
        ...
        if (SectionIt == Config.end())
        {
            HELIANTHUS_LOG_WARN("MongoDB configuration not found for connection: {}, using defaults", ConnectionName);
    ...
    RedisConfig DatabaseConfigManager::GetRedisConfig(const std::string& ConnectionName) const
    {
        ...
        if (SectionIt == Config.end())
        {
            HELIANTHUS_LOG_WARN("Redis configuration not found for connection: {}, using defaults", ConnectionName);
            return RedisConfig{};
        }
    ...
    ConnectionPoolConfig DatabaseConfigManager::GetPoolConfig(const std::string& ConnectionName) const
    {
        ...
        if (SectionIt == Config.end())
        {
            HELIANTHUS_LOG_WARN("Pool configuration not found for connection: {}, using defaults", ConnectionName);
    ...
    template<typename T>
    T DatabaseConfigManager::GetValue(const std::string& Section, const std::string& Key, const T& DefaultValue) const
    {
    ...
    void DatabaseConfigManager::SetValue(const std::string& Section, const std::string& Key, const ConfigValue& Value)
    {
    ...
    Common::ResultCode DatabaseConfigManager::ValidateConfiguration() const
    {
        ...
        return ValidationErrors.empty() ? Common::ResultCode::SUCCESS : Common::ResultCode::INVALID_PARAMETER;
    }
    ...
    MySqlConfig DatabaseConfigManager::ParseMySqlConfig(const ConfigSection& Section) const
    {
        ...
        Config.ConnectionTimeout = GetConfigValue(Section, "connection_timeout", Config.ConnectionTimeout);
    ...
    RedisConfig DatabaseConfigManager::ParseRedisConfig(const ConfigSection& Section) const
    {
        ...
        Config.MaxConnections = GetConfigValue(Section, "max_connections", Config.MaxConnections);
        Config.MinConnections = GetConfigValue(Section, "min_connections", Config.MinConnections);
        Config.KeyExpireSeconds = GetConfigValue(Section, "key_expire_seconds", Config.KeyExpireSeconds);
        return Config;
    }
    ...
    ConnectionPoolConfig DatabaseConfigManager::ParsePoolConfig(const ConfigSection& Section) const
    {
        ...
        Config.MinConnections = GetConfigValue(Section, "min_connections", Config.MinConnections);
        Config.MaxConnections = GetConfigValue(Section, "max_connections", Config.MaxConnections);
        Config.ConnectionTimeoutMs = GetConfigValue(Section, "connection_timeout_ms", Config.ConnectionTimeoutMs);
        Config.IdleTimeoutMs = GetConfigValue(Section, "idle_timeout_ms", Config.IdleTimeoutMs);
        Config.ValidationIntervalMs = GetConfigValue(Section, "validation_interval_ms", Config.ValidationIntervalMs);
    ...
    template<typename T>
    T DatabaseConfigManager::GetConfigValue(const ConfigSection& Section, const std::string& Key, const T& DefaultValue) const
    {
    ...
    template bool DatabaseConfigManager::GetValue<bool>(const std::string&, const std::string&, const bool&) const;
    template int32_t DatabaseConfigManager::GetValue<int32_t>(const std::string&, const std::string&, const int32_t&) const;
    template uint32_t DatabaseConfigManager::GetValue<uint32_t>(const std::string&, const std::string&, const uint32_t&) const;
    template uint64_t DatabaseConfigManager::GetValue<uint64_t>(const std::string&, const std::string&, const uint64_t&) const;
    template float DatabaseConfigManager::GetValue<float>(const std::string&, const std::string&, const float&) const;
    template double DatabaseConfigManager::GetValue<double>(const std::string&, const std::string&, const double&) const;
    template std::string DatabaseConfigManager::GetValue<std::string>(const std::string&, const std::string&, const std::string&) const;
