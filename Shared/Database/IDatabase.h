...
namespace Helianthus::Database
{
    ...
    public:
        ...
        virtual DatabaseResult ExecuteQuery(const std::string& QUERY, const ParameterMap& PARAMETERS = {}) = 0;
        virtual DatabaseResult ExecuteStoredProcedure(const std::string& PROCEDURE_NAME, const ParameterMap& PARAMETERS = {}) = 0;

        // Asynchronous operations
        virtual void ExecuteQueryAsync(const std::string& QUERY, QueryCallback CALLBACK, const ParameterMap& PARAMETERS = {}) = 0;
        virtual void ExecuteStoredProcedureAsync(const std::string& PROCEDURE_NAME, QueryCallback CALLBACK, const ParameterMap& PARAMETERS = {}) = 0;

        // Transaction support
        virtual std::shared_ptr<ITransaction> BeginTransaction(IsolationLevel LEVEL = IsolationLevel::READ_COMMITTED) = 0;
