...
namespace Helianthus::Network::Asio
{
    ...
    public:
        ...
        // 获取所有片段
        const std::vector<BufferFragment>& GetFragments() const { return Fragments; }
    ...
    public:
        ...
        // 获取读取目标
        const std::vector<std::pair<void*, size_t>>& GetTargets() const { return Targets; }
        ...
        // 检查是否为空
        bool IsEmpty() const { return Targets.empty(); }
