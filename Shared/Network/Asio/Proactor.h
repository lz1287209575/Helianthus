...
public:
    ...
    virtual void
    AsyncConnect(Fd Handle, const Network::NetworkAddress& Address, ConnectHandler Handler)
    {
    }
    ...
    // UDP 异步操作
    virtual void
    AsyncReceiveFrom(Fd Handle, char* Buffer, size_t BufferSize, UdpReceiveHandler Handler)
    {
    }
    virtual void AsyncSendTo(Fd Handle,
                             const char* Data,
                             size_t Size,
