...
TEST_F(PerformanceBenchmarkTest, BasicMessageThroughput)
{
    ...
    std::cout << "发送时间: " << std::fixed << std::setprecision(2) << SendTime << " ms"
              << std::endl;
...
TEST_F(PerformanceBenchmarkTest, CompressionPerformance)
{
    ...
    double CompressionOverhead =
        ((CompressionTime - NoCompressionTime) / NoCompressionTime) * 100.0;

    std::cout << "\n=== 压缩性能测试 ===" << std::endl;
    std::cout << "消息数量: " << MessageCount << std::endl;
    std::cout << "消息大小: " << MessageSize << " 字节" << std::endl;
    std::cout << "无压缩时间: " << std::fixed << std::setprecision(2) << NoCompressionTime << " ms"
              << std::endl;
...
TEST_F(PerformanceBenchmarkTest, EncryptionPerformance)
{
    ...
    std::cout << "消息数量: " << MessageCount << std::endl;
    std::cout << "消息大小: " << MessageSize << " 字节" << std::endl;
    std::cout << "无加密时间: " << std::fixed << std::setprecision(2) << NoEncryptionTime << " ms"
              << std::endl;
...
TEST_F(PerformanceBenchmarkTest, BatchProcessingPerformance)
{
    ...
    std::cout << "消息大小: " << MessageSize << " 字节" << std::endl;
    std::cout << "单个消息时间: " << std::fixed << std::setprecision(2) << SingleMessageTime
              << " ms" << std::endl;
...
TEST_F(PerformanceBenchmarkTest, ZeroCopyPerformance)
{
    ...
    std::cout << "普通发送时间: " << std::fixed << std::setprecision(2) << NormalTime << " ms"
              << std::endl;
...
TEST_F(PerformanceBenchmarkTest, ComprehensivePerformance)
{
    ...
    std::cout << "消息数量: " << MessageCount << std::endl;
    std::cout << "消息大小: " << MessageSize << " 字节" << std::endl;
    std::cout << "平均发送时间: " << std::fixed << std::setprecision(2) << AvgSendTime << " ms"
              << std::endl;
    ...
    std::cout << "发送吞吐量: " << CalculateThroughput(MessageCount, AvgSendTime) << " 消息/秒"
              << std::endl;
    std::cout << "接收吞吐量: " << CalculateThroughput(MessageCount, AvgReceiveTime) << " 消息/秒"
              << std::endl;
    std::cout << "批处理吞吐量: " << CalculateThroughput(MessageCount, AvgBatchTime) << " 消息/秒"
              << std::endl;
    std::cout << "零拷贝吞吐量: " << CalculateThroughput(MessageCount, AvgZeroCopyTime)
              << " 消息/秒" << std::endl;
