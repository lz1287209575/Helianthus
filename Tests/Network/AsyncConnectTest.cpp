...
TEST_F(AsyncConnectTest, AsyncConnectBasic)
{
    ...
    ContextPtr->Post(
        [ContextPtr, &ServerAddr, &ConnectCompleted, &ConnectError, AsyncSocket]()
        {
            AsyncSocket->AsyncConnect(
                ...
                [&ConnectCompleted, &ConnectError](Helianthus::Network::NetworkError Error)
                {
                    ...
                    std::cout << "AsyncConnect 完成，错误: " << static_cast<int>(Error)
                              << std::endl;
                });
        });
...
TEST_F(AsyncConnectTest, AsyncConnectCancel)
{
    ...
    ContextPtr->Post(
        [ContextPtr, &ServerAddr, &ConnectCancelled, &CancelError, AsyncSocket]()
        {
            AsyncSocket->AsyncConnect(
                ServerAddr,
                [&ConnectCancelled, &CancelError](Helianthus::Network::NetworkError Error)
                {
                    ...
                    std::cout << "AsyncConnect 取消完成，错误: " << static_cast<int>(Error)
                              << std::endl;
                });
...
TEST_F(AsyncConnectTest, AsyncConnectWithIO)
{
    ...
    ContextPtr->Post(
        [ContextPtr, &ServerAddr, &ConnectCompleted, &ConnectError, AsyncSocket]()
        {
            AsyncSocket->AsyncConnect(
                ServerAddr,
                [&ConnectCompleted, &ConnectError, AsyncSocket, ServerAddr](
