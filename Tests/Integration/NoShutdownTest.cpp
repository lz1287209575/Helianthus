...
class NoShutdownTest : public ::testing::Test
{
protected:
    void SetUp() override
    {
    ...
    {
        std::cout << "Tearing down test (no shutdown)..." << std::endl;
        // Don't call Shutdown() to see if that's the problem
...
// Test connection creation without shutdown
TEST_F(NoShutdownTest, CreateConnectionNoShutdown)
{
