...
TEST_F(EndToEndTest, MultiQueueEndToEndFlow) {
    ...
    std::string ReceivedData1(Received1->Payload.Data.begin(), 
                             Received1->Payload.Data.end());
    std::string ReceivedData2(Received2->Payload.Data.begin(), 
                             Received2->Payload.Data.end());
