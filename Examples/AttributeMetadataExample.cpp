...
public:
    ...
    {
        return ScreenWidth >= 640 && ScreenWidth <= 3840 && ScreenHeight >= 480 &&
               ScreenHeight <= 2160;
    }
...
public:
    ...
    std::string GetPlayerSummary() const
    {
        return PlayerName + " (Level " + std::to_string(Level) + ") - " +
               "HP: " + std::to_string(Health) + ", " + "MP: " + std::to_string(Mana) + ", " +
    ...
    void PrintPlayerData() const
    {
        ...
        std::cout << "Experience: " << Experience << "/" << GetExperienceForNextLevel()
                  << std::endl;
        std::cout << "Health: " << Health << std::endl;
        std::cout << "Mana: " << Mana << std::endl;
        std::cout << "Gold: " << Gold << std::endl;
        std::cout << "Language: " << Language << std::endl;
        std::cout << "Tutorial: " << (TutorialCompleted ? "Completed" : "Not completed")
                  << std::endl;
...
private:
    ...
    static void Demo3_MetadataIntrospection()
    {
        ...
        std::cout << "      - Tooltip=\"Game difficulty affects enemy strength and rewards\""
                  << std::endl;
    }
