...
int main()
{
    try
    {
        ...
        // 注册Helianthus风格类
        HelianthusManager.RegisterHelianthusClass(
            "HelianthusBaseObject", "HelianthusObject", {"Name", "ID"}, {"GetName", "SetName"});
        HelianthusManager.RegisterHelianthusClass("HelianthusPlayer",
                                                  "HelianthusBaseObject",
                                                  {"Health", "Speed", "IsAlive"},
                                                  {"TakeDamage", "Heal", "IsPlayerAlive"});
        HelianthusManager.RegisterHelianthusClass("HelianthusWeapon",
                                                  "HelianthusBaseObject",
                                                  {"Damage", "Range", "WeaponType"},
                                                  {"Upgrade", "IsRanged", "GetDescription"});
        ...
        // 生成Helianthus风格宏
        std::string HelianthusMacros =
            HelianthusCodeGenerator::GenerateHelianthusMacros("HelianthusPlayer");
        Logger::Info("生成的Helianthus风格宏:");
        Logger::Info(HelianthusMacros);

        // 生成Helianthus风格构建配置
        std::string HelianthusBuildConfig =
            HelianthusCodeGenerator::GenerateHelianthusBuildConfig("HelianthusPlayer");
