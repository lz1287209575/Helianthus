        ...
        for (const auto& Name : UClassNames) {
            ...
            if (Info) {
                ...
                for (const auto& PropName : PropertyNames) {
                    const UPropertyInfo* PropInfo = UReflectionSystem.GetUPropertyInfo(Name, PropName);
                    if (PropInfo) {
                ...
                for (const auto& FuncName : FunctionNames) {
                    const UFunctionInfo* FuncInfo = UReflectionSystem.GetUFunctionInfo(Name, FuncName);
                    if (FuncInfo) {
